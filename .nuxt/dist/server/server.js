...
/******/ 			var chunk = require("./" + ({"1":"components/business","2":"components/content","3":"components/content-last-content","4":"components/content-maincontent","5":"components/follow","6":"components/follow-advertisting","7":"components/follow-fashion","8":"components/fooddrink","9":"components/lifestyle","10":"components/post-catagory","11":"components/service","12":"components/socialmedia","13":"components/svgs-dribbble-icon","14":"components/svgs-facebook-icon","15":"components/svgs-instagram-icon","16":"components/svgs-linkedin-icon","17":"components/svgs-twitter-icon","18":"components/svgs-youtube-icon","19":"components/technology","20":"components/technology-maincontent","21":"components/travel","22":"components/typepost","23":"components/typetag","24":"pages/index"}[chunkId]||chunkId) + ".js");
...
__webpack_require__.d(components_namespaceObject, "Business", function() { return Business; });
...
__webpack_require__.d(components_namespaceObject, "SvgsFacebookIcon", function() { return SvgsFacebookIcon; });
__webpack_require__.d(components_namespaceObject, "SvgsInstagramIcon", function() { return SvgsInstagramIcon; });
__webpack_require__.d(components_namespaceObject, "SvgsLinkedinIcon", function() { return SvgsLinkedinIcon; });
__webpack_require__.d(components_namespaceObject, "SvgsTwitterIcon", function() { return SvgsTwitterIcon; });
__webpack_require__.d(components_namespaceObject, "SvgsYoutubeIcon", function() { return SvgsYoutubeIcon; });
__webpack_require__.d(components_namespaceObject, "Technology", function() { return Technology; });
__webpack_require__.d(components_namespaceObject, "TechnologyMaincontent", function() { return TechnologyMaincontent; });
__webpack_require__.d(components_namespaceObject, "Travel", function() { return Travel; });
__webpack_require__.d(components_namespaceObject, "Typepost", function() { return Typepost; });
__webpack_require__.d(components_namespaceObject, "Typetag", function() { return Typetag; });
...
const _77c08576 = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 24).then(__webpack_require__.bind(null, 122)));
...
const Business = () => __webpack_require__.e(/* import() | components/business */ 1).then(__webpack_require__.bind(null, 89)).then(c => wrapFunctional(c.default || c));
...
const SvgsFacebookIcon = () => __webpack_require__.e(/* import() | components/svgs-facebook-icon */ 14).then(__webpack_require__.bind(null, 83)).then(c => wrapFunctional(c.default || c));
const SvgsInstagramIcon = () => __webpack_require__.e(/* import() | components/svgs-instagram-icon */ 15).then(__webpack_require__.bind(null, 84)).then(c => wrapFunctional(c.default || c));
const SvgsLinkedinIcon = () => __webpack_require__.e(/* import() | components/svgs-linkedin-icon */ 16).then(__webpack_require__.bind(null, 85)).then(c => wrapFunctional(c.default || c));
const SvgsTwitterIcon = () => __webpack_require__.e(/* import() | components/svgs-twitter-icon */ 17).then(__webpack_require__.bind(null, 86)).then(c => wrapFunctional(c.default || c));
const SvgsYoutubeIcon = () => __webpack_require__.e(/* import() | components/svgs-youtube-icon */ 18).then(__webpack_require__.bind(null, 87)).then(c => wrapFunctional(c.default || c));
const Technology = () => __webpack_require__.e(/* import() | components/technology */ 19).then(__webpack_require__.bind(null, 90)).then(c => wrapFunctional(c.default || c));
const TechnologyMaincontent = () => __webpack_require__.e(/* import() | components/technology-maincontent */ 20).then(__webpack_require__.bind(null, 59)).then(c => wrapFunctional(c.default || c));
const Travel = () => __webpack_require__.e(/* import() | components/travel */ 21).then(__webpack_require__.bind(null, 94)).then(c => wrapFunctional(c.default || c));
const Typepost = () => __webpack_require__.e(/* import() | components/typepost */ 22).then(__webpack_require__.bind(null, 27)).then(c => wrapFunctional(c.default || c));
const Typetag = () => __webpack_require__.e(/* import() | components/typetag */ 23).then(__webpack_require__.bind(null, 26)).then(c => wrapFunctional(c.default || c));
